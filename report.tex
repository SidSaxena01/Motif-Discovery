...
\begin{itemize}
    \item \textbf{OCR Processing:} Raw text was extracted from the PDF using Optical Character Recognition.
...
To explore motif recurrence across various audio tracks, pitch contour segments are compared using DTW and pairwise similarity measures (e.g., via \texttt{stumpy.mass}). This analysis aims to uncover recurrent motifs that appear consistently across multiple tracks, offering insights into thematic connections within the dataset.
